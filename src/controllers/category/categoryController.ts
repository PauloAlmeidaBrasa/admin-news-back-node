...
export default class CategoryController {
  ...
  constructor(db: Knex) {
    ...
    this.category = new CategoryService(categoryRepository);
    const responseHelper = new ApiResponse();
  }
 ...
 */
  ...
  index = async (req: Request, res: Response) => {
    ...
    const clients = await this.category.allCategories(req.user.client_id);
    return ApiResponse.success(res, 'category', clients);
  }
